...
│   ├── 01-WHITE-PAPER-III-*-v9.0.html  # Primary document (+ PDF)
│   ├── 02-ARC-PRINCIPLE-*-v2.1.html    # Foundational paper (+ PDF)
│   ├── 03-EDEN-PROTOCOL-*-v4.0.html    # Eden Engineering (+ PDF)
│   ├── 04-EDEN-PROTOCOL-*-v1.0.html    # Eden Vision (+ PDF)
